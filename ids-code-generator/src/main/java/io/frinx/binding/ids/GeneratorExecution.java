...
final class GeneratorExecution implements AutoCloseable {
    ...
    private void processAugmentations(Set<AugmentationSchema> augNodes, Module module) {
        for (AugmentationSchema augNode : BindingLookup.sortAugNodes(augNodes)) {
    ...
    private void processAugmentation(Module module, AugmentationSchema augNode) {
        ...
        for (Type augType : augTypes) {
            ...
            template.addAugId(varName, augType.getFullyQualifiedName(),
